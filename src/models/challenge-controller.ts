...
export class ChallengeController extends BaseModel {
   ...
   */
  @OneToOne(() => War, war => war.universal)
   ...
   */
  @OneToOne(() => ChainWar, chainWar => chainWar.universal)
   ...
   */
  @OneToOne(() => Race, race => race.universal)
