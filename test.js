...
if (process.env.BOT_TOKEN !== '') {
  console.log('BOT_TOKEN exists.  Length: ' + process.env.BOT_TOKEN.length.toString() + ' First character: ' + process.env.BOT_TOKEN.charAt(0) + ' First character: ' + process.env.BOT_TOKEN.charAt(-1))
}
